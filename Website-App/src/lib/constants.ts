import { Goerli, BaseGoerli, Mumbai } from "@thirdweb-dev/chains";

export const THIRDWEB_API_KEY = "bf20f3e2e5d78187198b1dd6d8f041e1";
...
const chainInfos = {
  [Mumbai.chainId]: {
    ...
    openEditionContract: "0x05e32A6da695923d064fFd94053321fDbad573Ed",
  },
};

export const YACHT_CONTRACT = chainInfos[chain.chainId].openEditionContract;
